...
upper_done:                                       ; preds = %upper_loop
  ...
  %texto2 = load ptr, ptr %texto, align 8
  %strlen_call3 = call i64 @strlen(ptr %texto2)
  %comprimento_var = alloca i64, align 8
  store i64 %strlen_call3, ptr %comprimento_var, align 4
  %resultado4 = load ptr, ptr %resultado, align 8
  %printf_str_call = call i64 (ptr, ...) @printf(ptr @format_str, ptr %resultado4)
  %comprimento_var5 = load i64, ptr %comprimento_var, align 4
  %printf_int_call = call i64 (ptr, ...) @printf(ptr @format_str.1, i64 %comprimento_var5)
  ret i64 0
}
