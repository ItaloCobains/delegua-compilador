...
# %bb.0:                                # %entry
	...
	callq	malloc@PLT
	movq	%rax, %rbx
	movq	int_format.10@GOTPCREL(%rip), %rsi
	movq	%rax, %rdi
	movq	%r14, %rdx
	xorl	%eax, %eax
	callq	sprintf@PLT
	movq	string_literal.9@GOTPCREL(%rip), %r14
	movq	%r14, %rdi
	callq	strlen@PLT
	movq	%rax, %r15
	movq	%rbx, %rdi
	...
	movq	%rbx, %rsi
	callq	strcat@PLT
	movq	format_str.11@GOTPCREL(%rip), %rdi
	movq	%r15, %rsi
	xorl	%eax, %eax
	callq	printf@PLT
	xorl	%eax, %eax
...
string_literal.9:
	...
	.size	string_literal.9, 22

	.type	int_format.10,@object           # @int_format.10
	.globl	int_format.10
int_format.10:
	.asciz	"%lld"
	.size	int_format.10, 5

	.type	format_str.11,@object           # @format_str.11
	.globl	format_str.11
format_str.11:
	.asciz	"%s\n"
	.size	format_str.11, 4
