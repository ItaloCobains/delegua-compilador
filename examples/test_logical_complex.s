...
Lloh13:
	...
	bl	_sprintf
Lloh14:
	adrp	x22, _string_literal.6@PAGE
Lloh15:
	add	x22, x22, _string_literal.6@PAGEOFF
	mov	x0, x22
	bl	_strlen
	mov	x23, x0
	mov	x0, x21
	...
	bl	_sprintf
Lloh16:
	adrp	x20, _string_literal.7@PAGE
Lloh17:
	add	x20, x20, _string_literal.7@PAGEOFF
	mov	x0, x20
	bl	_strlen
	mov	x22, x0
	mov	x0, x21
	...
	.p2align	4, 0x0
_string_literal:
	.asciz	"Teste de preced\303\252ncia:"
