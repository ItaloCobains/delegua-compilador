...
@string_literal = global [31 x i8] c"Testando apenas raiz quadrada:\00"
@format_str = global [4 x i8] c"%s\0A\00"
@string_literal.1 = global [21 x i8] c"Raiz quadrada de 4: \00"
@int_format = global [5 x i8] c"%lld\00"
@format_str.2 = global [4 x i8] c"%s\0A\00"
@string_literal.3 = global [21 x i8] c"Raiz quadrada de 9: \00"
...
entry:
  ...
  %module_call = call i64 @matematica_raiz_quadrada(i64 4)
  ...
  %module_call2 = call i64 @matematica_raiz_quadrada(i64 9)
